...
import SaksinformasjonPanel from '../old/components/saksinformasjon-panel/SaksinformasjonPanel';
import SøkNåPanel from '../old/components/søk-nå-panel/SøkNåPanel';
