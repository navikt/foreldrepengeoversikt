...
import CalendarIkon from '../old/components/ikoner/CalendarIkon';
import { Routes } from 'app/utils/routes';

import Person from 'app/types/Person';
import SakBase from 'app/api/types/sak/Sak';
import PeriodeOversikt from '../old/components/periode-oversikt/PeriodeOversikt';
import { finnNåværendePerioder, finnFremtidigePerioder, finnTidligerePerioder } from 'app/utils/periodeUtils';
import OversiktBrukteDager from '../old/common/components/oversikt-brukte-dager/OversiktBrukteDager';
